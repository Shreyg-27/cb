...
with col6:
    ...
    st.image("Images/KhushiJainDi.jpg")
    st.caption("Khushi Jain")
    st_button('linkedin', 'https://www.linkedin.com/in/khushi-jain-bb3bb9201/', 'LinkedIn', icon_size)
...
with col7:
    ...
    st.image("Images/KhushiSinhaDi.jpeg")
